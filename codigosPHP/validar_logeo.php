<?php
	...
	$consulta = "SELECT nombre_usuario, clave_usuario, id_usuario, email_usuario, nombre_tipo_usuario FROM usuario, tipo_usuario where usuario.id_tipo_usuario = tipo_usuario.id_tipo_usuario AND nombre_usuario ='".$us."' AND clave_usuario='".md5($pass)."'";
